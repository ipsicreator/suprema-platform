...
export default function ExplorationPage() {
  ...
  return (
    <FlowShell
      ...
      title="탐구·세특 제안"
      subtitle="학생부 신호와 직접 입력 키워드를 결합해 탐구, 독서, 세특 연결 결과를 제안합니다."
      steps={[
      ...
      footer={
        <div className="rounded-[28px] border border-[#0f172a] bg-[#0f1e3b] px-6 py-5 text-center text-white shadow-[0_18px_44px_rgba(15,23,42,0.18)]">
          <p className="text-lg font-extrabold">나의 입시멘토 탐구·세특·입시위치진단 흐름에 맞춰 결과를 연결합니다.</p>
        </div>
      }
    >
      <div className="max-w-5xl mx-auto">
        <header className="mb-10 text-center">
          <div className="flex flex-col items-center gap-4 mb-6">
            <div className="v-badge">나의 입시멘토 · 탐구·세특·입시위치진단</div>
            <h1 className="text-5xl font-black tracking-tight">
              <span className="v-highlight">탐구·세특 제안</span>
            </h1>
          </div>
          <p className="text-[var(--text-secondary)] text-lg max-w-2xl mx-auto">
            학생부 3개 신호와 직접 입력 3개를 결합해 탐구 주제, 독서, 세특 연결 결과를 함께 보여줍니다.
          </p>
          ...
          <AnimatePresence mode="wait">
            {!showHistory ? (
              ...
              >
                ...
                >
                  {loading ? "탐구·세특 제안을 생성하는 중입니다..." : "탐구·세특 제안 생성하기"}
                </button>
              </motion.div>
            ) : (
              <motion.div
