  ...
  return (
    <FlowShell
      ...
      steps={[
        ...
        { no: "02", title: "학생부/성적분석", description: "PDF, 이미지 PDF, 이미지 파일을 모두 처리합니다.", icon: <FileSearch className="h-5 w-5" /> },
        { no: "03", title: "탐구/독서 제안", description: "과목/등급/학년 흐름을 시각화합니다.", icon: <Brain className="h-5 w-5" /> },
        { no: "04", title: "입시위치 진단", description: "탐구 주제와 보고서 단계로 이어집니다.", icon: <FileCheck2 className="h-5 w-5" /> },
      ]}
    >
