...
export default function DiagnosisStep1Page() {
  ...
  return (
    <FlowShell
      badge="AI 탐구 · 세특 솔루션"
      title="학생부 등록"
      subtitle="개인 사용자 정보 입력 → 학생부 분석 → 탐구 주제 추천 → 보고서/독서 제안까지 같은 화면 톤으로 연결합니다."
      steps={[
        ...
        { no: "03", title: "학생부 분석", description: "과목/등급/학년 흐름을 시각화합니다.", icon: <Brain className="h-5 w-5" /> },
        { no: "04", title: "탐구로 이동", description: "탐구 주제와 보고서 단계로 이어집니다.", icon: <FileCheck2 className="h-5 w-5" /> },
      ]}
    >
